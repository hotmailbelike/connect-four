document.addEventListener('DOMContentLoaded', () => {
	...
	squares.forEach((e, i) => {
		((index) => {
			//add an onClick to each square on the grid
			squares[i].onclick = () => {
				//if the square below your current square is taken, you can put disk on top of it
				...
				//if the square below your current square is not taken then, you can't put disk there
				else {
	...
	//check the board if any player won
	const checkBoard = () => {
